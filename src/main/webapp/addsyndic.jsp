...
<div class="container">
    ...
    <main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 border">
                <div class="bg-gray-900 md:col-span-4 p-10 text-white">
                    ...
                    <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
                        Some <span class="text-indigo-600">Instruction</span>
                    </h3>
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
                ...
                <form action="addsyndic" method="post"  class="md:col-span-8 p-10 bg-white">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                    ...
                                    type="text" id="name" name="name" required placeholder="Syndic2">
                        </div>
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                   for="residence">
                            ...
                            <input
                                    ...
                                    type="text" id="residence" name="residence" required placeholder="Jasmine">
                        </div>
